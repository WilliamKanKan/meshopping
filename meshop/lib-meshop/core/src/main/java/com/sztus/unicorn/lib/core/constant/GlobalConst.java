package com.sztus.meshop.lib.core.constant;
...
public interface GlobalConst {
    ...
    String AWS_BUCKET = "esignwiz";

    String OSS_ESW_RESOURCE = "https://"+ AWS_BUCKET + ".s3-ap-southeast-1.amazonaws.com/resource/";
    String OSS_ESW_SECURITY = "https://"+ AWS_BUCKET + ".s3-ap-southeast-1.amazonaws.com/security/";

	String SCAN_BASE_PACKAGE = "com.sztus";
