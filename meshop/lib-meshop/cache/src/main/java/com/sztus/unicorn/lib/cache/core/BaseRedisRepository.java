package com.sztus.meshop.lib.cache.core;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.sztus.meshop.lib.core.constant.CodeConst;
import com.sztus.meshop.lib.core.constant.GlobalConst;
import com.sztus.meshop.lib.core.util.CryptUtil;
import com.sztus.meshop.lib.core.util.StringUtil;
...
public abstract class BaseRedisRepository {
    ...
    public Long cacheCount(String cacheKey, Long delta) {
        ...
        Long increment = redisWriterTemplate().opsForValue().increment(storeKey, delta);
        return increment;
    }
     ...
     *
     * @param cacheKey 缓存键
     * @param itemStr  删除的的单条数据
     * @param args     JSONObject中键
     */
    public void removeFromSet(String cacheKey, String itemStr, Object... args) {
        String storeKey = generateKey(cacheKey, args);
        redisWriterTemplate().opsForSet().remove(storeKey, itemStr);
    }
     ...
     * @param args     JSONObject中键
     */
    public Long getSizeFromSet(String cacheKey, Object... args) {
        String storeKey = generateKey(cacheKey, args);
        return redisWriterTemplate().opsForSet().size(storeKey);
    }
    ...
    public void convertAndSend(String channel, String message) {
        primaryWriterRedisTemplate.convertAndSend(channel, message);
    }
